...
import { Label } from "@pzhown/ui/components/label"
...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "tw:group/field-label tw:peer/field-label tw:flex tw:w-fit tw:gap-2 tw:leading-snug tw:group-data-[disabled=true]/field:opacity-50 tw:has-data-checked:border-primary/30 tw:has-data-checked:bg-primary/5 tw:has-data-selected:border-primary/30 tw:has-data-selected:bg-primary/5 tw:has-[>[data-slot=field]]:rounded-lg tw:has-[>[data-slot=field]]:border tw:has-[>[data-slot=field]]:not-has-[:disabled,[data-disabled]]:hover:bg-muted/50 tw:has-[>[data-slot=field]]:has-[:focus-visible]:border-ring tw:has-[>[data-slot=field]]:has-[:focus-visible]:ring-3 tw:has-[>[data-slot=field]]:has-[:focus-visible]:ring-ring/50 tw:*:data-[slot=field]:p-2.5 tw:dark:has-data-checked:border-primary/20 tw:dark:has-data-checked:bg-primary/10 tw:dark:has-data-selected:border-primary/20 tw:dark:has-data-selected:bg-primary/10",
