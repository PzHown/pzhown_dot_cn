...
function AvatarImage({ className, ...props }: React.ComponentProps<"img">) {
  ...
  return (
    <img
      ...
      className={cn(
        "tw:peer tw:aspect-square tw:size-full tw:rounded-full tw:object-cover tw:data-[state=error]:hidden",
        className
      )}
      {...props}
    />
...
function AvatarFallback({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "tw:flex tw:size-full tw:items-center tw:justify-center tw:rounded-full tw:bg-muted tw:text-sm tw:text-muted-foreground tw:group-data-[size=sm]/avatar:text-xs tw:peer-data-[state=error]:flex tw:peer-[*]:hidden",
        className
      )}
      {...props}
    />
